...
```javascript
import slice from 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-base-slice@v0.2.0-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/ndarray-base-slice/actions/workflows/test.yml/badge.svg?branch=v0.2.0
[test-url]: https://github.com/stdlib-js/ndarray-base-slice/actions/workflows/test.yml?query=branch:v0.2.0
